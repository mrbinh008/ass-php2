    ...
    <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
        <div class="auth-box bg-dark border-top border-secondary">
            <div id="loginform">
                ...
                <!-- Form -->
                <form class="form-horizontal m-t-20" id="loginform" action="{{url("auth")}}" method="post">
{{--                    @isset($_SESSION['error'])--}}
{{--                        <div class="alert alert-danger alert-dismissible fade {{isset($_SESSION['error'])?'show':''}}" role="alert">--}}
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <div class="p-t-20">
                                    ...
                                    <button class="btn btn-success float-right" type="submit" name="btnLogin">Login</button>
                                </div>
                            </div>
                        </div>
                    </div>
